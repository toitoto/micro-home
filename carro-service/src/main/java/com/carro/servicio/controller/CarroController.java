package com.carro.servicio.controller;
...
import com.carro.servicio.service.CarroService;
...
public class CarroController {
	...
	public ResponseEntity<List<Carro>> carrosUsuario(@PathVariable("id") int id) {
